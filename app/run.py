...
def insert_drugin():
    ...
    if user_info:
        if request.method == 'POST':
            ...
            success = drugadminRole.insert_drugin(in_number, drug_name, batch, n, notes, instruction, supplier_id,
                                                  drugadmin_id)
            return render_template('drugadmin/insert_drugin.html', user_info=user_info, success=success)
        else:
            return render_template('drugadmin/insert_drugin.html', user_info=user_info, error='')
    else:
        return redirect(url_for('login'))
